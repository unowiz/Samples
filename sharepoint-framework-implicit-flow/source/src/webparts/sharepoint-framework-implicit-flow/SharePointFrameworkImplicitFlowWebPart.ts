...
export interface ISharePointFrameworkImplicitFlowWebPartProps {
    appId: string;
    authUrl: string;
    resourceUrl: string;
}

export default class SharePointFrameworkImplicitFlowWebPart extends BaseClientSideWebPart<ISharePointFrameworkImplicitFlowWebPartProps> {
                        ...
                        this.context.httpClient.get(requestUrl, HttpClient.configurations.v1, {
                            ...
                            .then((data: any) => {
                                this.domElement.innerHTML = `
                                    <div class="${styles.sharepointframeworkimplicitflow}">
